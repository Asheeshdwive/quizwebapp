...
function showResult() {
    ...
    if (userScore > 4) { // if user scored more than 3
        ...
        let scoreTag = '<span>and congrats!🎉,You got Very Strong <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag; //adding new span tag inside score_Text
    } else if (userScore > 3) { // if user scored more than 1
        let scoreTag = '<span>and nice 😎, You got Strong <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';
